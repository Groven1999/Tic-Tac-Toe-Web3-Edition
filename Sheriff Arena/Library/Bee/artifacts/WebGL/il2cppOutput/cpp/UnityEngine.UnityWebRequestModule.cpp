...
IL_03c7_1:
			{
				...
				L_164 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(42 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_163);
				V_20 = L_164;
				goto IL_03dc;
			}
		}// end try (depth: 1)
...
IL_009a_1:
			...
			}
			{
				...
				L_50 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(42 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_49);
				V_7 = L_50;
				goto IL_00be;
			}
		}// end try (depth: 1)
...
IL_0035:
	{
		...
		int32_t L_18 = V_0;
		int32_t L_19;
		L_19 = VirtualFuncInvoker4< int32_t, Il2CppChar*, int32_t, uint8_t*, int32_t >::Invoke(22 /* System.Int32 System.Text.Encoding::GetBytes(System.Char*,System.Int32,System.Byte*,System.Int32) */, L_13, L_14, L_16, L_17, L_18);
		V_2 = L_19;
		V_6 = (String_t*)NULL;
		uint8_t* L_20 = V_1;
		int32_t L_21 = V_2;
...
// System.Void UnityEngine.Networking.MultipartFormDataSection::.ctor(System.Byte[])
